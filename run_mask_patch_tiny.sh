...
dataset=asli
tr_data=/home/taan222d/workspaces/beegfs/taan222d-birds/ssast/src/pretrain/data/train.json
te_data=/home/taan222d/workspaces/beegfs/taan222d-birds/ssast/src/pretrain/data/eval.json
...
--task ${task} --lr_patience ${lr_patience} --epoch_iter 50 #800